...
./setup.sh --use-case pipeline-defect-custom \
...
├── prompts/
│   └── pipeline-defect-custom.txt  # LLM prompts (section-based)
└── .env_pipeline-defect-custom     # Environment variable overrides
```
...
1. Copy this directory: `cp -r pipeline-defect-custom weld-defect-detection`
